...
//	public String input100ReviewCorporeaDirectory = "E:/mine/javaworkspace/AMC_master/Data/Input/nokia_data_Ã÷À¼/foramc";
	
	@Option(name = "-ibig", usage = "Specify the input directory of each domain "
			+ "where each domain contains 1000 reviews with vocabulary")
	public String input1000ReviewCorporeaDirectory = "./Data/Input/1000Reviews/Non-Electronics/";
...
//	public int nthreads = 2;
	...
	// Print out top words ranked by probabilities per
