...
public class Corpus {
	...
	public int[][] docs = null; // doc_id mat
	public String[][] docsStr = null; // doc_str mat
	...
	public static Corpus getCorpusFromFile(String domain, String docsFilepath,
		...
		// Read the vocab file.
		// System.out.println(vocabFilepath);
		...
		int size = docsLines_nonEmpty.size(); // #docs in one domain
		corpus.docs = new int[size][]; // doc_id mat
		corpus.docsStr = new String[size][]; // doc_str mat
		for (int d = 0; d < size; ++d) {
			...
			for (int n = 0; n < length; ++n) {
				...
				HashSet<Integer> setOfDocs = corpus.wordstrToSetOfDocsMap
						.get(wordstr);	//每个词wordstr对应的所有doc的id
				setOfDocs.add(d);
			}
		}
